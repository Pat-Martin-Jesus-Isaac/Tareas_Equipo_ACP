package Unidad10_ActividadesFecha;
	...
	public class AU10_EJ10_12EmpleadoPorHoras extends  AU10_EJ10_12Nomina
	{
	   private double sueldo; // sueldo por hora
	   private double horas; // horas trabajadas por semana
	 
	  // constructor
	   public AU10_EJ10_12EmpleadoPorHoras(String primerNombre, String apellidoPaterno,String numeroSeguroSocial, double sueldo, double horas)
	    {
