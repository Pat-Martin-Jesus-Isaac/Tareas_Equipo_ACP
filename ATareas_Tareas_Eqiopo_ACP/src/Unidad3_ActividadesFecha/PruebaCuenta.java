...
public class PruebaCuenta {
	    ...
	    public static void main(String[] args) {
	    	Actividad3_15_Cuenta cuenta1 = new Actividad3_15_Cuenta("Jane Green", 50.00);
	    	Actividad3_15_Cuenta cuenta2 = new Actividad3_15_Cuenta("John Blue", -7.53);
	    ...
	    public static void mostrarCuenta(Actividad3_15_Cuenta cuentaAMostrar) {
