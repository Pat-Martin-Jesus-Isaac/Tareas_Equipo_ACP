...
public class Actividad3_17RregistrosMedicos {
	...
	public Actividad3_17RregistrosMedicos(String name, String lastName, char sex, int day, int month, int year, double height, double weight){	
		this.setName(name);
