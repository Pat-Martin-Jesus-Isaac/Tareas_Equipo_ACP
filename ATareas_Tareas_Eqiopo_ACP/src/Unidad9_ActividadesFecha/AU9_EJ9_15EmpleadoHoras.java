package Unidad9_ActividadesFecha;
	...
	public class AU9_EJ9_15EmpleadoHoras extends AU9_EJ9_15Empleado {
		
		public AU9_EJ9_15EmpleadoHoras(String primerNombre, String apellidoPaterno, String numeroSeguroSocial, double sueldo, double horas) {
			super(primerNombre, apellidoPaterno, numeroSeguroSocial, sueldo, horas);
		}

		public static void main(String[] args) {
			AU9_EJ9_15EmpleadoHoras empleado = new AU9_EJ9_15EmpleadoHoras("Juan", "Perez", "123-45- 6789", 15.25, 40);
