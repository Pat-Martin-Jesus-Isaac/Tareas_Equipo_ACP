...
public class AU4_EJ4_19_Comisiones {
...
Scanner input = new Scanner(System.in);
	...
	public void comisionXVta(){
		...
		System.out.printf("\nLa comision por las ventas del Articulo 1: $%.2f",(this.articuloUno*this.getQty1())*0.09);
		System.out.printf("\nLa comision por las ventas del Articulo 2: $%.2f",(this.articuloDos*this.getQty2())*0.09);
		System.out.printf("\nLa comision por las ventas del Articulo 3: $%.2f",(this.articuloTres*this.getQty3())*0.09);
		System.out.printf("\nLa comision por las ventas del Articulo 4: $%.2f",(this.articuloCuatro*this.getQty4())*0.09);
		
		System.out.printf("\n\nLos ingresos del vendedor de la semana son: $%.2f", 200 + (this.articuloUno*this.getQty1())*0.09 + (this.articuloDos*this.getQty2())*0.09 + (this.articuloTres*this.getQty3())*0.09 + (this.articuloCuatro*this.getQty4())*0.09);
		System.out.println();
